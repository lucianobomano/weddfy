            ...
            <div className="hidden lg:block">
              <div className="flex flex-col items-center justify-center min-h-screen py-4">
                <div className="flex justify-center items-start gap-4 p-6 w-full">
                  ...
                  <motion.div
                    className="w-[320px] xl:w-[350px] flex-shrink-0 bg-[#FAFAF9] rounded-sm shadow-lg overflow-hidden h-[calc(100vh-6rem)] border border-[#810100]/10"
                ...
                <footer className="mt-2 text-[9px] tracking-[0.15em] text-[#810100]/50 uppercase font-semibold select-none">
                  Desenvolvido por{' '}
                  <a 
            ...
            <div className="hidden md:block lg:hidden">
              <div className="flex flex-col items-center justify-center min-h-screen py-4">
                ...
                <div className="flex justify-center items-start gap-3 p-4 w-full">
                  <div className="w-[280px] flex-shrink-0 bg-[#FAFAF9] rounded-sm shadow-md overflow-hidden min-h-[75vh]">
                    <LeftPanel />
                  </div>
                  <div className="w-[280px] flex-shrink-0 bg-[#FAFAF9] rounded-sm shadow-md overflow-hidden min-h-[75vh]">
                    <MiddlePanel />
